...
\small
\textsc{Amount payable in words: \textbf{$priceinwords$} only.}

\vspace{5mm}

\null\hfill \includegraphics[scale=0.25]{signature}

\small
\null\hfill Authorized Signatory

\vspace{10mm}

\textbf{Bank Account Details:}
\begin{itemize}
$for(bankdetails)$ \item $bankdetails$
$endfor$ \end{itemize}
